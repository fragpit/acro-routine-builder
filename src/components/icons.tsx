...
/** Circular arrow used for the pull-to-refresh app-update indicator. */
export function IconRefresh({
  ...
  return (
    <svg {...SVG_PROPS} className={className} style={style} aria-hidden="true">
...
/** Checkmark used to confirm "up to date" after an update check. */
